...
export const NEWS_PAGE = 'news-page'
export const ONE_NEWS_PAGE = 'one-news-page'
export const FLIGHT_SCHEDULE_PAGE = 'flight-schedule-page'
export const TRANSPORTATION_RULES_PAGE = 'transportation-rules-page'
